...
class EntityRelationControllerClient extends base_client_1.BaseVXOlympusClient {
    async saveRelationWithData(data, options = {}) {
     ...
     */
    async findByQueryUsingPOST_3WithData(data, options = {}) {
     ...
     */
    async findInfoByQueryWithData(data, options = {}) {
     ...
     * @returns {Promise<Array<schemas.EntityRelationInfo>>}
     */
    async findInfoByFrom(queryParams, options = {}) {
        const url = `${this.baseUrl}/api/relations/info{?fromId,fromType,relationTypeGroup}`;
        const params = new URLSearchParams();
        if (queryParams) {
            if (queryParams.fromId !== undefined)
                params.set('fromId', String(queryParams.fromId));
            if (queryParams.fromType !== undefined)
                params.set('fromType', String(queryParams.fromType));
            if (queryParams.relationTypeGroup !== undefined)
                params.set('relationTypeGroup', String(queryParams.relationTypeGroup));
        }
     ...
     * @returns {Promise<Array<schemas.EntityRelationInfo>>}
     */
    async findInfoByTo(queryParams, options = {}) {
        const url = `${this.baseUrl}/api/relations/info{?relationTypeGroup,toId,toType}`;
        const params = new URLSearchParams();
        if (queryParams) {
            if (queryParams.toId !== undefined)
                params.set('toId', String(queryParams.toId));
            if (queryParams.toType !== undefined)
                params.set('toType', String(queryParams.toType));
            if (queryParams.relationTypeGroup !== undefined)
                params.set('relationTypeGroup', String(queryParams.relationTypeGroup));
        }
        const queryString = params.toString();
     ...
     */
    async deleteRelations(queryParams, options = {}) {
        const url = `${this.baseUrl}/api/relations{?entityId,entityType}`;
        const params = new URLSearchParams();
        if (queryParams) {
            if (queryParams.entityId !== undefined)
                params.set('entityId', String(queryParams.entityId));
            if (queryParams.entityType !== undefined)
                params.set('entityType', String(queryParams.entityType));
        }
        const queryString = params.toString();
        const response = await this.makeRequest(url + (queryString ? `?${queryString}` : ''), {
            method: 'DELETE',
     ...
     * @returns {Promise<Array<schemas.EntityRelation>>}
     */
    async findByFrom(queryParams, options = {}) {
        ...
        if (queryParams) {
            ...
            if (queryParams.fromType !== undefined)
                params.set('fromType', String(queryParams.fromType));
            if (queryParams.relationType !== undefined)
                params.set('relationType', String(queryParams.relationType));
            if (queryParams.relationTypeGroup !== undefined)
                params.set('relationTypeGroup', String(queryParams.relationTypeGroup));
        }
        const queryString = params.toString();
     ...
     * @returns {Promise<Array<schemas.EntityRelation>>}
     */
    async findByTo(queryParams, options = {}) {
     ...
     */
    async getRelation(queryParams, options = {}) {
     ...
     * @returns {Promise<void>}
     */
    async deleteRelation(queryParams, options = {}) {
        const url = `${this.baseUrl}/api/relation{?fromId,fromType,relationType,relationTypeGroup,toId,toType}`;
        const params = new URLSearchParams();
        if (queryParams) {
            if (queryParams.fromId !== undefined)
