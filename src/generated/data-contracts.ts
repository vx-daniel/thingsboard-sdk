...
export type AlarmAssignmentNotificationRuleTriggerConfig =
...
export type AlarmNotificationRuleTriggerConfig =
  (NotificationRuleTriggerConfig & {
    /** @uniqueItems true */
    alarmSeverities?: (
      | "CRITICAL"
...
export type ApiUsageLimitNotificationRuleTriggerConfig =
  (NotificationRuleTriggerConfig & {
    /** @uniqueItems true */
    apiFeatures?: (
      | "ALARM"
...
export type CoapDeviceProfileTransportConfiguration =
...
export type DefaultCoapDeviceTypeConfiguration =
  (CoapDeviceTypeConfiguration & {
...
export type DeviceActivityNotificationRuleTriggerConfig =
  (NotificationRuleTriggerConfig & {
    /** @uniqueItems true */
...
export type DisabledDeviceProfileProvisionConfiguration =
  (DeviceProfileProvisionConfiguration & {
    provisionDeviceSecret?: string;
  }) & {
    provisionDeviceSecret?: string;
...
export type EmailDeliveryMethodNotificationTemplate =
  (DeliveryMethodNotificationTemplate & {
    body?: string;
    enabled?: boolean;
    subject?: string;
...
export type EntitiesLimitNotificationRuleTriggerConfig =
  (NotificationRuleTriggerConfig & {
    /** @uniqueItems true */
    entityTypes?: (
      | "ALARM"
...
export type EntityActionNotificationRuleTriggerConfig =
  (NotificationRuleTriggerConfig & {
    created?: boolean;
    deleted?: boolean;
    /** @uniqueItems true */
...
export type JsonTransportPayloadConfiguration =
  TransportPayloadTypeConfiguration & object;
...
export type Lwm2MDeviceProfileTransportConfiguration =
  (DeviceProfileTransportConfiguration & {
...
export type Lwm2MDeviceTransportConfiguration =
  (DeviceTransportConfiguration & {
    /** @format int64 */
    edrxCycle?: number;
    /** @format int64 */
...
export type MicrosoftTeamsNotificationTargetConfig =
...
export type PSKLwM2MBootstrapServerCredential =
  (LwM2MBootstrapServerCredential & {
    /**
     * Server short Id. Used as link to associate server Object Instance. This identifier uniquely identifies each LwM2M Server configured for the LwM2M Client. This Resource MUST be set when the Bootstrap-Server Resource has a value of 'false'. The values ID:0 and ID:65535 values MUST NOT be used for identifying the LwM2M Server.
     * @format int32
...
export type PlatformUsersNotificationTargetConfig =
  (NotificationTargetConfig & {
    description?: string;
...
export type ProtoTransportPayloadConfiguration =
...
export interface RateLimitsNotificationRuleTriggerConfig {
  ...
  apis?: (
    ...
    | "ENTITY_EXPORT"
    | "ENTITY_IMPORT"
    | "INTEGRATION_MSGS_PER_DEVICE"
    | "INTEGRATION_MSGS_PER_TENANT"
...
export type RuleEngineComponentLifecycleEventNotificationRuleTriggerConfig =
  (NotificationRuleTriggerConfig & {
...
export type SharedAttributesSettingSnmpCommunicationConfig =
...
export type SnmpDeviceProfileTransportConfiguration =
  (DeviceProfileTransportConfiguration & {
...
export type TelemetryQueryingSnmpCommunicationConfig =
  (SnmpCommunicationConfig & {
    mappings?: SnmpMapping[];
    /** @format int64 */
    queryingFrequencyMs?: number;
...
export type X509CertificateChainProvisionConfiguration =
  (DeviceProfileProvisionConfiguration & {
...
export type GetAutoCommitSettingsUsingGetData = Record<
  string,
  AutoVersionCreateConfig
>;

export type SaveAutoCommitSettingsUsingPostPayload = Record<
  string,
  AutoVersionCreateConfig
>;

export type SaveAutoCommitSettingsUsingPostData = Record<
  string,
  AutoVersionCreateConfig
>;
...
export type SaveRepositorySettingsUsingPostData =
  DeferredResultRepositorySettings;
...
export enum GetHighestAlarmSeverityUsingGetData {
  CRITICAL = "CRITICAL",
...
export type CompareEntityDataToVersionUsingGetData =
  DeferredResultEntityDataDiff;

/** @format uuid */
export type LoadEntitiesVersionUsingPostData = string;

export type ListEntitiesAtVersionUsingGetData =
  DeferredResultListVersionedEntityInfo;

export type GetVersionLoadRequestStatusUsingGetData = VersionLoadResult;

export type ListAllEntitiesAtVersionUsingGetData =
  DeferredResultListVersionedEntityInfo;
...
export type ListEntityVersionsUsingGetData =
  DeferredResultPageDataEntityVersion;
...
export type ListEntityTypeVersionsUsingGetData =
  DeferredResultPageDataEntityVersion;
...
export type GetSharedEntityGroupEntityInfosByTypeAndPageLinkUsingGetData =
  PageDataEntityInfo;
...
export type GetEntityGroupEntityInfosByTypeAndPageLinkUsingGetData =
  PageDataEntityInfo;
...
export type GetEntityGroupEntityInfosByOwnerAndTypeAndPageLinkUsingGetData =
  PageDataEntityInfo;
...
export type GetEntityGroupEntityInfosHierarchyByOwnerAndTypeAndPageLinkUsingGetData =
  PageDataEntityInfo;
...
export type GetSharedEntityGroupsByTypeAndPageLinkUsingGetData =
...
export type GetEntityGroupsByTypeAndPageLinkUsingGetData =
  PageDataEntityGroupInfo;
...
export type GetEntityGroupsByOwnerAndTypeAndPageLinkUsingGetData =
  PageDataEntityGroupInfo;
...
export type GetEntityGroupsHierarchyByOwnerAndTypeAndPageLinkUsingGetData =
  PageDataEntityGroupInfo;
...
export type FindEntityTimeseriesAndAttributesKeysByQueryUsingPostData =
...
export type GetNotificationRequestPreviewUsingPostData =
  NotificationRequestPreview;
...
export type GetNotificationRequestsUsingGetData =
...
export type SaveUserNotificationSettingsUsingPostData =
  UserNotificationSettings;
...
export type GetRecipientsForNotificationTargetConfigUsingPostData =
  PageDataUser;
...
export type GetNotificationTargetsBySupportedNotificationTypeUsingGetData =
...
export type GetClientRegistrationTemplatesUsingGet1Data =
  OAuth2ClientRegistrationTemplate[];

export type SaveClientRegistrationTemplateUsingPostData =
  OAuth2ClientRegistrationTemplate;
...
export type HandleOneWayDeviceRpcRequestUsingPostData =
  DeferredResultResponseEntity;

export type HandleTwoWayDeviceRpcRequestUsingPostPayload = string;

export type HandleTwoWayDeviceRpcRequestUsingPostData =
  DeferredResultResponseEntity;

export type HandleOneWayDeviceRpcRequestUsingPost1Payload = string;

export type HandleOneWayDeviceRpcRequestUsingPost1Data =
  DeferredResultResponseEntity;
...
export type HandleTwoWayDeviceRpcRequestUsingPost1Data =
  DeferredResultResponseEntity;
...
export type GetRuleChainOutputLabelsUsageUsingGetData =
  RuleChainOutputLabelsUsage[];
...
export type HandleRuleEngineRequestUsingPost3Data =
  DeferredResultResponseEntity;

export type HandleRuleEngineRequestUsingPost2Payload = string;

export type HandleRuleEngineRequestUsingPost2Data =
  DeferredResultResponseEntity;

export type HandleRuleEngineRequestUsingPost1Payload = string;

export type HandleRuleEngineRequestUsingPost1Data =
  DeferredResultResponseEntity;
...
export type GetSchedulerEventInfoByIdUsingGetData =
  SchedulerEventWithCustomerInfo;
...
export type GetSignUpSelfRegistrationParamsUsingGetData =
  SignUpSelfRegistrationParams;
...
export type DeleteSelfRegistrationParamsUsingDeleteData =
  DeferredResultResponseEntity;
...
export enum SignUpUsingPostData {
...
export type GetSolutionTemplateDetailsUsingGetData =
  TenantSolutionTemplateDetails;

export type GetSolutionTemplateInfosUsingGetData = TenantSolutionTemplateInfo[];

export type GetSolutionTemplateInstructionsUsingGetData =
  TenantSolutionTemplateInstructions;
...
export type DeleteDeviceAttributesUsingDeleteData =
  DeferredResultResponseEntity;
...
export type DeleteEntityTimeseriesUsingDeleteData =
  DeferredResultResponseEntity;

export type SaveEntityTelemetryWithTtlUsingPostPayload = string;

export type SaveEntityTelemetryWithTtlUsingPostData =
  DeferredResultResponseEntity;
...
export type DeleteEntityAttributesUsingDeleteData =
  DeferredResultResponseEntity;
...
export type GetCurrentLoginWhiteLabelParamsUsingGetData =
  LoginWhiteLabelingParams;
...
export type GetBundleWidgetTypesDetailsByBundleAliasUsingGetData =
  WidgetTypeDetails[];
...
export type GetBundleWidgetTypesInfosByBundleAliasUsingGetData =
  WidgetTypeInfo[];
